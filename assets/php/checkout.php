    ...
    <div class="checkout-container">
      ...
      <div class="form-container">
        ...
        <div class="auth-forms-container">
          <form id="login-form" class="checkout-form" action="auth.php" method="POST">
            ...
            <div class="button-container">
              <button type="submit" name="login" class="primary-button">Entrar</button>
              <button type="button" class="auth-toggle-btn" onclick="toggleForms()">Não tem uma conta? Registre-se</button>
            </div>
          </form>

          <form id="register-form" class="checkout-form" action="auth.php" method="POST">
            ...
            <div class="input-line">
              ...
              <input type="password" id="register-password" name="register-password" required placeholder="" autocomplete="off" />
            </div>
            <div class="input-line">
            ...
            <div class="input-line">
              ...
              <input type="text" name="cep" required autocomplete="off" onblur="buscarEndereco()" oninput="mascaraCEP(this)">
            </div>
            <div class="input-line">
            ...
            <div class="input-line">
              ...
              <input type="text" name="cpf" required autocomplete="off" oninput="mascaraCPF(this)">
            </div>
            <div class="input-line">
              <label for="telefone">Telefone</label>
              <input type="text" name="telefone" required autocomplete="off" oninput="mascaraTelefone(this)">
            </div>
            <div class="input-line">
            ...
            <div class="button-container">
              <button type="submit" name="register" class="primary-button">Registrar</button>
